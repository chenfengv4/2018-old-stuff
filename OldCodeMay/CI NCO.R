...
data1<- data[,c(2,19,3,15)]
head(data1)

data1$l4X1<-lag(data1$X1_B,4)
data1$l2dX13<- lag(diffn(data1$X13_B,1),2)


reg<- arima(data1$Y30, xreg= cbind(l4X1=data1$l4X1, l2dX13=data1$l2dX13 ),
            include.mean = T, order=c(0,0,0))
reg


reg<-lm(data1$Y30~data1$l4X1 + data1$l2dX13 )
summary(reg)
...
write.xlsx(resiw, 'residualsC&IeNCO.xlsx', sheetName = 'C&IeNCO')
