...
data1<- data[,c(2,25,3,8)]
head(data1)

data1$dY<-diffn(data1$Y38,1)

data1$l2X1<-lag(data1$X1_B,2)

data1$l4X6<-lag(data1$X6_B,4)


reg<- arimax(data1$dY, order=c(1,0,0), 
             xtransf =   cbind(l2X1=data1$l2X1, l4X6=data1$l4X6    ), 
...
write.xlsx(resiw, 'residualsCommercialRealEstateNCO.xlsx', sheetName = 'CommercialRealEstateNCO')
