...
data1$l4dX9<- lag(diffn(data1$X9_B,1),4)

reg<- lm(data1$dY~data1$l3X1 + data1$l2X4 + data1$l4dX9)

summary(reg)

reg<-arima(data1$dY, order=c(0,0,0),xreg=cbind(data1$l3X1, data1$l2X4, data1$l4dX9),  include.mean = T)
reg
...
write.xlsx(resiw, 'residualCRE_NA.xlsx', sheetName = 'CRE_NA')
