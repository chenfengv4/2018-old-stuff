...
data1$l2dX15<-lag(diffn(data1$X15_B,1),2)

reg<- arimax(data1$Y32, order=c(1,0,0),
             xtransf = cbind(lX6 =data1$lX6, l2dX15=data1$l2dX15), 
             transfer = list(c(0,1),c(0,2)), include.mean = F,
...
write.xlsx(resiw, 'residualOtherConstructionNCO.xlsx', sheetName = 'OtherConstructionNCO')
